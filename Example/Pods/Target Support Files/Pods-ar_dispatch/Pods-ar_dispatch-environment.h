...
// ar_dispatch
#define COCOAPODS_POD_AVAILABLE_ar_dispatch
#define COCOAPODS_VERSION_MAJOR_ar_dispatch 1
#define COCOAPODS_VERSION_MINOR_ar_dispatch 0
#define COCOAPODS_VERSION_PATCH_ar_dispatch 0
